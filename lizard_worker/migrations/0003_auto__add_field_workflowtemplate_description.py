...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkflowTemplate.description'
        db.add_column('lizard_worker_workflowtemplate', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WorkflowTemplate.description'
        db.delete_column('lizard_worker_workflowtemplate', 'description')
