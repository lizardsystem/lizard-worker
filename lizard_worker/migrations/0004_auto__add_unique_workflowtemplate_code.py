...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'WorkflowTemplate', fields ['code']
        db.create_unique('lizard_worker_workflowtemplate', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'WorkflowTemplate', fields ['code']
        db.delete_unique('lizard_worker_workflowtemplate', ['code'])
